...
public class SpiderForIBM extends Spider {
  ...
  // //对网页内容进行分析和提取
  // //设置文章的标题
  // //MetaTag titleTag = ParseUtils.parseTag(html, MetaTag.class, "name",
  // "title");
  // TitleTag titleTag = ParseUtils.parseTag(html, TitleTag.class);
  // a.setTitle(titleTag.getText());
  //
  // //设置文章的关键字
  // MetaTag keywordTag = ParseUtils.parseTag(html, MetaTag.class, "name",
  // "Keywords");
  ...
  // // author = author + ParseUtils.parseTag(div.getStringText(),
  ...
  // content = ParseUtils.modifyImageUrl(content,
  // "upload_image/"+a.getTitle()+"/");
